const  FAKHRIBOT = 'FAKHRIBOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/fakhri2005'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+628124002238'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota ama mood :v'; // Kapan bot lu aktif
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=628124002238:+62 812-4002-238\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] FAKHRIBOT Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @fakhri2005`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @fakhri2005`)
})
...
conn.sendMessage(id, 'Owner FAKHRIBOT wa.me/+628124002238' ,MessageType.text);
}
else if (text == 'fakhri'){
conn.sendMessage(id, 'Aku BOT nya FAKHRIBOT' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, 'SUCCES, MERUBAH NAMA GRUP' ,MessageType.text, { quoted: m } );
...
conn.sendMessage(id, 'SUCCES, MERUBAH DESK GRUP' ,MessageType.text, { quoted: m } );
...
axios.get(`https://arugaz.herokuapp.com/api/chord?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Proses...⏳', MessageType.text)
    let hasil = `*Nih Cord Lagunya ${teks} kak* \n\nCord: _${res.data.result}_ `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, menu.menu(id,  FAKHRIBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  FAKHRIBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  FAKHRIBOT, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id,  FAKHRIBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#foto'){
conn.sendMessage(id, 'kirim .foto cewek/cowok\n\nContoh: .foto cewek' ,MessageType.text);
}
else if (text == '#menu'){
conn.sendMessage(id, ' 😇Thanks Telah Menggunakan *FAKHRIBOT* , Follow Instagram  Yah💕 : https://instagram.com/@fakhri2005' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' ??Thanks Telah Menggunakan *FAKHRIBOT* , Follow Instagram  Yah💕 : https://instagram.com/@fakhri2005' ,MessageType.text);
}
